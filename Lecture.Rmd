...
Text for a test of forced alignment: _Den ale Mann ass an dat kaalt Waasser gefall._ (The old man fell into th cold water.) with the corresponding sound file save together in the same directory.
...
Groups of sounds can be grouped together to `label groups`:
- all long monophthongs:  `"iː", "uː", "aː", "oː", "ɔː", "ɛː", "eː"`
- all short monophthongs: `"i", "u", "ɑ", "o", "æ", "e", "ə", "ɐ"`
